...
RUN apt-get update && apt-get install -y \
    # C build tools and other basics
    build-essential autoconf libtool wget \
    # Python dependencies
    python-pip \
    git \
    pkg-config \
...
# Build C++ grpc and protobuf/protoc
...
COPY grpc-builder /grpc-builder
ENTRYPOINT /grpc-builder
